...
from data_utils_sp import ConcatTokensDataset, NoConcatDataset
...
def main(args: Namespace) -> None:
    ...
    if args.concat_tokens is not None:
        ...
        # SentencePieceのモデルの読み込み
        tokenizer = spm.SentencePieceProcessor()
        tokenizer.Load(args.tokenizer)  # モデルのパスを指定
    ...
    # Get samples
    dataset = build_hf_dataset(tokenizer=tokenizer,
                               path=args.path,
                               split=args.split,
                               mode=mode,
